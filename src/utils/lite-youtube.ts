/**
 * lite-youtube web component utility
 * A lightweight YouTube embed that loads faster and improves performance.
 * Based on @justinribeiro/lite-youtube
 */
...
export class LiteYTEmbed extends HTMLElement {
  ...
  private setupComponent(): void {
    ...
    const hasImgSlot: HTMLSlotElement = this.shadowRoot.querySelector('slot[name=image]')!;
...
/**
 * Initialize the lite-youtube web component
 * Registers the custom element if not already registered
 */
export const initLiteYouTube = (): void => {
